# Deliverable 5: Communication & Adoption Plan
This plan details the change management strategy to support the rollout of Microsoft Copilot, ensuring staff are informed, trained, and aligned with the new data security and sensitivity labeling policies established in the previous deliverables [cite: 1, 2].
## 1. Communication Strategy
Our approach centers on transparency, emphasizing that security and efficiency are synergistic rather than competing goals.

| Phase | Audience | Key Message |
| :--- | :--- | :-- |
| Phase 1: Awareness (Weeks 1-2) | All Staff | "Better Work, Safer Data." Introduce Copilot’s capabilities and the importance of classification in maintaining Assembly integrity. |
| Phase 2: Enablement (Week 3) | Power Users / Dept Leads | Targeted training on sensitivity labels and how to handle "Confidential" or "Restricted" data in their daily workflows. |
| Phase 3: Launch (Week 4) | All Staff | Go-live announcement. Accessing support and reporting incidents. |
